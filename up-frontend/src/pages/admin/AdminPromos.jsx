...
export default function AdminPromos() {
  ...
  const fetchPromos = usePromoStore((s) => s.fetchPromos);
  const savePromo = usePromoStore((s) => s.savePromo);
  const deletePromo = usePromoStore((s) => s.deletePromo);
                ...
                <tr key={p.id}>
                  ...
                  <td>
                    <div className="row wrap">
                      ...
                      <button
                        className="btn"
                        onClick={() => savePromo({ ...p, active: !p.active })}
                      >
          ...
          <div className="row wrap">
            ...
            <div style={{ width: 160 }}>
              ...
              <input
                ...
                value={editing.value}
                onChange={(e) =>
                  setEditing({ ...editing, value: Number(e.target.value || 0) })
                }
              />
            </div>
          </div>
